...
from pytube.exceptions import VideoUnavailable, VideoPrivate, VideoRegionBlocked, AgeRestrictedError, RegexMatchError
    ...
    def download_video(self):
        ...
        try:
            try:
                ...
                print(f"Video {yt_object.title} {e} is unavailable, skipping.")
            except RegexMatchError  as e:
                print(f"Video {yt_object.title} {e} is unavailable, skipping.")
        except (VideoUnavailable, VideoPrivate, VideoRegionBlocked, AgeRestrictedError) as e:
            print(f"Video {yt_object.title} is unavailable, skipping.")
